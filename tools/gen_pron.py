...
(˥˦˧˨˩) close a syllable. Sources per language:
  ...
  gr    Dia-thìris IPA from the dictionary (word lexicon for sentences, espeak gd fallback with sc read as sg)
"""
...
GR_NAMES = {'dia-thìr': 'ˈtʃiəˈhiːɾʲ', 'dia-thìris': 'ˈtʃiəˈhiːɾʲɪʃ', 'dia-thìrich': 'ˈtʃiəˈhiːɾʲɪç', 'dia-thìreach': 'ˈtʃiəˈhiːɾʲəx'}   # as rodais_engine.pronounce() gives them
