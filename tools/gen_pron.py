...
(˥˦˧˨˩) close a syllable. Sources per language:
  ...
  gr    Diaithìris IPA from the dictionary (word lexicon for sentences, espeak gd fallback with sc read as sg)
"""
...
GR_NAMES = {'diaithìr': 'ˈtʃiəˈhiːɾʲ', 'diaithìris': 'ˈtʃiəˈhiːɾʲɪʃ', 'diaithìrich': 'ˈtʃiəˈhiːɾʲɪç', 'diaithìreach': 'ˈtʃiəˈhiːɾʲəx'}   # as diaithiris_engine.pronounce() gives them
