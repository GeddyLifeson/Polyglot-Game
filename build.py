...
LANG_META = {
    ...
    'la': ('Latin', 'Latina', '🏛️', 'it-IT', False, True),
    ...
    'gr': ('Dia-thìris', 'Dia-thìris', '🏝️', 'gd-GB', True, True),   # the tongue of Dia-thìr; reading line = IPA; recorded with OmniVoice (tools/gen_audio.py --backend omnivoice)
}
